...
--
-- Host: 127.0.0.1
-- Generation Time: Feb 18, 2025 at 06:42 AM
...
CREATE TABLE `add_product` (
  ...
  `Product Quantity` varchar(100) NOT NULL,
...
INSERT INTO `add_product` (`Product Id`, `Product Name`, `Product Price`, `Product Quantity`, `Product Category`, `Product Image`) VALUES
(1, 'Crystal Touch Lamp', '740', '1', 'Gifts', 'img74.jpg'),
(2, 'LED Bottle', '220', '1', 'Unique Gifts', 'img56.jpg'),
(3, 'Birthday Gift', '1390', '1', 'Customized Gifts', 'img62.jpg'),
(4, 'Photo Wall Decor', '380', '1', 'Gifts', 'img78.jpg'),
(5, 'Bunny Rabbit', '250', '1', 'Kids', 'img37.jpg'),
(6, 'Gift set for men', '480', '1', 'Men', 'img80.jpg'),
(7, 'Clock', '2350', '1', 'Unique Gifts', 'img27.jpg'),
(8, 'Photo Lamp', '500', '1', 'Customized Gifts', 'img68.jpg'),
(9, 'Explosive gift box', '500', '1', 'Customized Gifts', 'img10.jpg'),
(10, 'Customized gift', '750', '1', 'Customized Gifts', 'img53.jpg'),
(11, 'Gift hamper', '600', '1', 'Unique Gifts', 'img21.jpg'),
(12, 'Watch set', '1750', '1', 'Gifts', 'img95.jpg'),
(13, 'Customized Cup', '650', '1', 'Customized Gifts', 'img13.jpg'),
(14, 'Photo Frame', '799', '1', 'Customized Gifts', 'img64.jpg'),
(15, 'Wall Decor', '864', '1', 'Unique Gifts', 'img71.jpg');
...
--
-- Table structure for table `systemtest`
--
...
--
-- Dumping data for table `systemtest`
--

INSERT INTO `systemtest` (`Id`, `Name`, `Email`, `Phone`, `Gender`, `Image`, `Password`) VALUES
(1, 'Rose', 'rose12@gmail.com', '9876543700', 'Female', 'images1.jpeg', 'rose12'),
(2, 'Akal', 'Akal123@gmail.com', '9876543210', 'Female', 'images.jpeg', 'akal123'),
(3, 'Abi', 'Abi9876@gmail.com', '9458432168', 'Female', 'ace60.jpeg', '9876');
...
INSERT INTO `user_details` (`Id`, `Name`, `Number`, `Email`, `Password`, `Confirm Password`, `State`, `Country`) VALUES
(1, 'Bharath', '9998887775', 'bharath14@gmail.com', '1426', '1426', '35', '101'),
(2, 'Harshini', '9614327543', 'Harshini12@gmail.com', 'shini12', 'shini12', '35', '101'),
(3, 'Rose', '9873492100', 'rose1426@gmail.com', 'rose1426', 'rose1426', '265', '13'),
(4, 'Rani', '8746298744', 'rani26@gmail.com', 'rani2611', 'rani2611', '3798', '229'),
(5, 'Abi', '9876543210', 'Abi9876@gmail.com', 'Abi9876', 'Abi9876', '3866', '230'),
(6, 'Abisha', '7945017600', 'Abisha@gmail.com', 'abi456', 'abi456', '2065', '116');
...
CREATE TABLE `user_product` (
  ...
  `Product Quantity` varchar(50) NOT NULL,
...
INSERT INTO `user_product` (`Id`, `Product Name`, `Product Category`, `Product Price`, `Product Quantity`, `Total Amount`, `Product Image`, `user_id`, `Status`) VALUES
(1, 'LED Bottle', 'Unique Gifts', '220', '3', '660.00', 'img56.jpg', 1, 1),
(2, 'Photo Lamp', 'Customized Gifts', '500', '1', '500.00', 'img68.jpg', 1, 2),
(3, 'Photo Wall Decor', 'Gifts', '380', '1', '380.00', 'img78.jpg', 3, 2),
(4, 'Customized gift', 'Customized Gifts', '750', '1', '750.00', 'img53.jpg', 3, 1),
(5, 'Gift hamper', 'Unique Gifts', '600', '1', '600.00', 'img21.jpg', 3, 1),
(6, 'Clock', 'Unique Gifts', '2350', '1', '2350.00', 'img27.jpg', 4, 2),
(7, 'Customized gift', 'Customized Gifts', '750', '1', '750.00', 'img53.jpg', 1, 0);
...
--
-- Indexes for table `systemtest`
--
ALTER TABLE `systemtest`
  ADD PRIMARY KEY (`Id`);
...
--
ALTER TABLE `add_product`
  MODIFY `Product Id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=20;
...
--
-- AUTO_INCREMENT for table `systemtest`
--
ALTER TABLE `systemtest`
